...
import PlatformSettingsPage from './page/PlatformSettings/PlatformSettingsPage';
import CDRPage from "./page/CDR-CallDetailRecord/CDR-CallDetailRecord";
import SDRPage from "./page/SDR-SubscriberDetailRecord/SDR-SubscriberDetailRecord";
import TDRPage from "./page/TDR-TowerDumpRecord/TDR-TowerDumpRecord";
import ILDPage from "./page/ILD-InternationalLongDistance/ILD-InternationalLongDistance";
import ITDRPage from "./page/ITDR-InternetTrafficDetailRecord/ITDR-InternetTrafficDetailRecord";
import IPDRPage from "./page/IPDR-InternetProtocolDetailRecord/IPDR-InternetProtocolDetailRecord";
import IDRPage from "./page/IDR-InternetDataRecord/IDR-InternetDataRecord";
import LARPage from "./page/LAR-LocationAnalysisRecord/LAR-LocationAnalysisRecord";
import OSINTPage from "./page/OSINT-OpenSourceIntelligence/OSINT-OpenSourceIntelligence";
import SMIPage from "./page/SMI-SocialMediaIntelligence/SMI-SocialMediaIntelligence";
import BSARPage from "./page/BSAR-BankStatementAnalysisReport/BSAR-BankStatementAnalysisReport";
import BRIPage from "./page/BRI-BankRecordIntelligence";
import RTOIPage from "./page/RTOI-RegionalTransportOfficeIntelligence";
import PRIPage from "./page/PRI-PrisonRecordIntelligence/PRI-PrisonRecordIntelligence";
import LIHPage from "./page/LIH-LawIntelligenceHub/LIH-LawIntelligenceHub";
import BIPage from "./page/BI-BiometricIntelligence/BI-BiometricIntelligence";
import FRIPage from "./page/FRI-FacialRecognitionIntelligence/FRI-FacialRecognitionIntelligence";
import LRIPage from "./page/LRI-LandRecordIntelligence/LRI-LandRecordIntelligence";
import ERIPage from "./page/ERI-EducationRecordIntelligence/ERI-EducationRecordIntelligence";
import KYCDIPage from "./page/KYCDI-KYCDocumentIntelligence/KYCDI-KYCDocumentIntelligence";

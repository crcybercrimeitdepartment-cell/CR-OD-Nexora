...
import TTIPage from "./TTI-TollTransactionIntelligence";
import VIPage from "./VI-VehicleIntelligence";
import FTIPage from "./FTI-FASTagIntelligence";
import TPIPage from "./TPI-TollPlazaIntelligence";
import MIPage from "./MI-MovementIntelligence";
import RIPage from "./RI-RouteIntelligence";
import TLIPage from "./TLI-TimelineIntelligence";
import PIPage from "./PI-PatternIntelligence";
import RKIPage from "./RKI-RiskIntelligence";
import RLIPage from "./RLI-RelationshipIntelligence";
import AIPage from "./AI-AnalyticsIntelligence";
import IOPage from "./IO-InvestigationOutput";

...
import BankBranchRecordReportPage from './BANK BRANCH RECORD REPORT/BankBranchRecordReportPage.jsx';
...
export default function Explorethewebpage({ activePage, setActivePage }) {
  ...
  const handleSearch = (e) => {
    ...
    const searchTerm = query.trim() || 'All Bank Branches';

...
export default function WebCameraSettingPage({ onBack }) {
  return (
    <div className="w-full flex-1 flex flex-col items-center justify-center min-h-[50vh] p-8">
      ...
      <h2 className="text-2xl sm:text-3xl font-black text-[#1e2a52] mb-4 text-center tracking-tight">Web Camera Setting</h2>
      <p className="text-slate-500 font-medium text-center max-w-lg text-sm sm:text-base leading-relaxed">
        Configure camera permissions, default devices, and background effects.
      </p>

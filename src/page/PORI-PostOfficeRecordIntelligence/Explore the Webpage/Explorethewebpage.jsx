...
import PinCodeRecordReportPage from './PIN CODE RECORD REPORT/PinCodeRecordReportPage.jsx';
...
export default function Explorethewebpage({ activePage, setActivePage }) {
  ...
  const handleSearch = (e) => {
    ...
    const searchTerm = query.trim() || 'All Post Offices';

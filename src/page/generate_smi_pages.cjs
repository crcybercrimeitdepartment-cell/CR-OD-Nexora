...
const tools = [
  ["CI", "Contact Intelligence"],
  ["PI", "Profile Intelligence"],
  ["CRI", "Communication Registration Intelligence"],
  ["FBPI", "Facebook Platform Intelligence"],
  ["IGI", "Instagram Intelligence"],
  ["XTI", "X (Twitter) Intelligence"],
  ["LII", "LinkedIn Intelligence"],
  ["TGI", "Telegram Intelligence"],
  ["WAI", "WhatsApp Intelligence"],
  ["SCI", "Snapchat Intelligence"],
  ["YTI", "YouTube Intelligence"],
  ["GBI", "Google Business Intelligence"],
  ["PMI", "Payment Intelligence"],
  ["SHI", "Shopping Intelligence"],
  ["FDI", "Food Delivery Intelligence"],
  ["TRI", "Travel Intelligence"],
  ["CSI", "Cab Service Intelligence"],
  ["SBI", "Subscription Intelligence"],
  ["MDI", "Media Intelligence"],
  ["TLI", "Timeline Intelligence"]
];
...
const dir = path.join(__dirname, 'smi');
...
console.log("Files updated in smi/");

...
import AS1Page from './Profile';
import AS6Page from './ActiveSessions';
import AS7Page from './DeviceManagement';
import AS8Page from './LoginHistory';
import AS9Page from './SearchHistory';
import AS10Page from './TimelineHistory';
import AS11Page from './WorkHistory';
import AS13Page from './DeleteHistory';
import AS15Page from './BackupRestore';
import AS16Page from './StorageUsage';
import AS18Page from './SubscriptionBilling';
import AS26Page from './DeleteAccount';

...
import NNPage from './NewNumbers';
import CNPage from './CommonNumbers';
import CWSMPage from './CompareWithSuspectMobileNumbers';
import ILDD1Page from './ILD-DEMO_1';
import ILDD2Page from './ILD-DEMO_2';
import ILDD3Page from './ILD-DEMO_3';
import ILDD4Page from './ILD-DEMO_4';
...
export default function ILDPage({ onBack }) {
  const { dynamicGridClass, displayTools } = usePageLayout('ild', ILD_TOOLS);

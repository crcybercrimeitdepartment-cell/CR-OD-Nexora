...
import CRICollPage from "./ERI-EducationRecordIntelligence/CRI-CollegeRecordIntelligence";
import URIPage from "./ERI-EducationRecordIntelligence/URI-UniversityRecordIntelligence";
import IRIPage from "./ERI-EducationRecordIntelligence/IRI-InstituteRecordIntelligence";
import OTRIPage from "./ERI-EducationRecordIntelligence/OTRI-OnlineTutorialRecordIntelligence";
import HRIPage from "./ERI-EducationRecordIntelligence/HRI-HostelRecordIntelligence";
import SRIPage from "./ERI-EducationRecordIntelligence/SRI-SchoolRecordIntelligence";
...
export default function ERIPage({ onBack }) {
  ...
  useEffect(() => {
    const handlePopState = (event) => {
      if (event.state && event.state.page === 'ERI' && event.state.subPage) {
  ...
  const handleSelectSubPage = (id) => {
    window.history.pushState({ page: 'ERI', subPage: id }, '', '#ERI-' + id);
  ...
  if (selectedSubPage === 'sir') return <SIRPage onBack={handleSubPageBack} />;
  if (selectedSubPage === 'cri_cert') return <CRICertPage onBack={handleSubPageBack} />;
  if (selectedSubPage === 'cri_coll') return <CRICollPage onBack={handleSubPageBack} />;
  if (selectedSubPage === 'uri') return <URIPage onBack={handleSubPageBack} />;
  if (selectedSubPage === 'iri') return <IRIPage onBack={handleSubPageBack} />;
  if (selectedSubPage === 'otri') return <OTRIPage onBack={handleSubPageBack} />;
  if (selectedSubPage === 'hri') return <HRIPage onBack={handleSubPageBack} />;

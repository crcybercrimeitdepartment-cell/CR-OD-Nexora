...
export default function PostalAddressIdentificationAndVerificationPage() {
  ...
  const title = PostalAddressIdentificationAndVerificationPage.moduleData.name;
  const description = PostalAddressIdentificationAndVerificationPage.moduleData.desc;
...
PostalAddressIdentificationAndVerificationPage.moduleData = {
  id: 'postal-address',
  name: 'Postal Address Identification & Verification',
  desc: 'Standardize, validate, and geocode postal addresses.',
  icon: (p) => <Home {...p} />,
  color: 'text-pink-600',
  bg: 'bg-pink-50'
};

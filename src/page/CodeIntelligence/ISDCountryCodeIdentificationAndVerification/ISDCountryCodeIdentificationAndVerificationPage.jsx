...
export default function ISDCountryCodeIdentificationAndVerificationPage() {
  ...
  const title = ISDCountryCodeIdentificationAndVerificationPage.moduleData.name;
  const description = ISDCountryCodeIdentificationAndVerificationPage.moduleData.desc;
...
ISDCountryCodeIdentificationAndVerificationPage.moduleData = {
  id: 'isd-code',
  name: 'ISD Country Code Identification & Verification',
  desc: 'Lookup international dialing codes and country standards.',
  icon: (p) => <Globe {...p} />,
  color: 'text-cyan-600',
  bg: 'bg-cyan-50'
};

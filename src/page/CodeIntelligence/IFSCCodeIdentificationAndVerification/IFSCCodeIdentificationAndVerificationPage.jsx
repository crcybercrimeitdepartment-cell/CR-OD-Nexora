...
export default function IFSCCodeIdentificationAndVerificationPage() {
  ...
  const title = IFSCCodeIdentificationAndVerificationPage.moduleData.name;
  const description = IFSCCodeIdentificationAndVerificationPage.moduleData.desc;
...
IFSCCodeIdentificationAndVerificationPage.moduleData = {
  id: 'ifsc-code',
  name: 'IFSC Code Identification & Verification',
  desc: 'Lookup bank branch details, MICR, and routing codes.',
  icon: (p) => <Landmark {...p} />,
  color: 'text-sky-500',
  bg: 'bg-sky-50'
};

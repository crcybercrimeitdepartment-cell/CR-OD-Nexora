...
export default function BankAccountNumberIdentificationAndVerificationPage() {
  ...
  const title = BankAccountNumberIdentificationAndVerificationPage.moduleData.name;
  const description = BankAccountNumberIdentificationAndVerificationPage.moduleData.desc;
...
BankAccountNumberIdentificationAndVerificationPage.moduleData = {
  id: 'bank-account',
  name: 'Bank Account Number Identification & Verification',
  desc: 'Validate account structure and cross-reference financial data.',
  icon: (p) => <CreditCard {...p} />,

import { Search, StickyNote, History, Folder } from 'lucide-react';

export default function DashboardPage({ setActivePage }) {
  return (
    <>
      <div className="relative z-10 w-full flex flex-col items-center pt-6 sm:pt-8 md:pt-10 px-2 sm:px-6 animate-in fade-in zoom-in-95 duration-700 pb-16">

      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4 gap-4 md:gap-6 w-full max-w-[1400px] px-2 sm:px-6 animate-in fade-in slide-in-from-bottom-12 duration-1000 delay-150 fill-mode-both">
        
        {/* Search Card */}
        <div 
          onClick={() => setActivePage('search')}
          className="group bg-white/80 backdrop-blur-md w-full p-3.5 sm:p-4 rounded-2xl border border-white/60 shadow-md shadow-slate-200/40 hover:shadow-xl hover:shadow-blue-500/10 cursor-pointer transition-all duration-300 flex flex-row items-center hover:-translate-y-1 relative overflow-hidden"
        >
        ...
        <div 
          ...
          className="group bg-white/80 backdrop-blur-md w-full p-3.5 sm:p-4 rounded-2xl border border-white/60 shadow-md shadow-slate-200/40 hover:shadow-xl hover:shadow-purple-500/10 cursor-pointer transition-all duration-300 flex flex-row items-center hover:-translate-y-1 relative overflow-hidden"
        >
        ...
        <div 
          ...
          className="group bg-white/80 backdrop-blur-md w-full p-3.5 sm:p-4 rounded-2xl border border-white/60 shadow-md shadow-slate-200/40 hover:shadow-xl hover:shadow-amber-500/10 cursor-pointer transition-all duration-300 flex flex-row items-center hover:-translate-y-1 relative overflow-hidden"
        >
        ...
        <div 
          ...
          className="group bg-white/80 backdrop-blur-md w-full p-3.5 sm:p-4 rounded-2xl border border-white/60 shadow-md shadow-slate-200/40 hover:shadow-xl hover:shadow-indigo-500/10 cursor-pointer transition-all duration-300 flex flex-row items-center hover:-translate-y-1 relative overflow-hidden"
        >

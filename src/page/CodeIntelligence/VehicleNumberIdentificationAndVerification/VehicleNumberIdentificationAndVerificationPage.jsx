...
export default function VehicleNumberIdentificationAndVerificationPage() {
  ...
  const title = VehicleNumberIdentificationAndVerificationPage.moduleData.name;
  const description = VehicleNumberIdentificationAndVerificationPage.moduleData.desc;
...
VehicleNumberIdentificationAndVerificationPage.moduleData = {
  id: 'vehicle-number',
  name: 'Vehicle Number Identification & Verification',
  desc: 'Retrieve RTO registration and vehicle owner details.',
  icon: (p) => <Car {...p} />,

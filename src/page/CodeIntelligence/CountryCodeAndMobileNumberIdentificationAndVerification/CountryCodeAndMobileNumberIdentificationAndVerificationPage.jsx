...
export default function CountryCodeAndMobileNumberIdentificationAndVerificationPage() {
  ...
  const title = CountryCodeAndMobileNumberIdentificationAndVerificationPage.moduleData.name;
  const description = CountryCodeAndMobileNumberIdentificationAndVerificationPage.moduleData.desc;
...
CountryCodeAndMobileNumberIdentificationAndVerificationPage.moduleData = {
  id: 'country-code',
  name: 'Country Code & Mobile Number Identification & Verification',
  desc: 'Global country code lookup and mobile number validation.',
  icon: (p) => <Globe {...p} />,

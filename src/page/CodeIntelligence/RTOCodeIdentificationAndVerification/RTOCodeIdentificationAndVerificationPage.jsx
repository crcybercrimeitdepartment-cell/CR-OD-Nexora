...
export default function RTOCodeIdentificationAndVerificationPage() {
  ...
  const title = RTOCodeIdentificationAndVerificationPage.moduleData.name;
  const description = RTOCodeIdentificationAndVerificationPage.moduleData.desc;
...
RTOCodeIdentificationAndVerificationPage.moduleData = {
  id: 'rto-code',
  name: 'RTO Code Identification & Verification',
  desc: 'Lookup regional transport offices and jurisdictions.',
  icon: (p) => <Map {...p} />,

...
export default function VehicleEngineNumberIdentificationAndVerificationPage() {
  ...
  const title = VehicleEngineNumberIdentificationAndVerificationPage.moduleData.name;
  const description = VehicleEngineNumberIdentificationAndVerificationPage.moduleData.desc;
...
VehicleEngineNumberIdentificationAndVerificationPage.moduleData = {
  id: 'engine-number',
  name: 'Vehicle Engine Number Identification & Verification',
  desc: 'Verify vehicle engine specifications and OEM records.',
  icon: (p) => <Wrench {...p} />,

...
export default function IPAddressIdentificationAndVerificationPage() {
  ...
  const title = IPAddressIdentificationAndVerificationPage.moduleData.name;
  const description = IPAddressIdentificationAndVerificationPage.moduleData.desc;
...
IPAddressIdentificationAndVerificationPage.moduleData = {
  id: 'ip-address',
  name: 'IP Address Identification & Verification',
  desc: 'Trace IP allocations, geolocation, and network routing.',
  icon: (p) => <Server {...p} />,
  color: 'text-pink-500',
  bg: 'bg-pink-50'
};

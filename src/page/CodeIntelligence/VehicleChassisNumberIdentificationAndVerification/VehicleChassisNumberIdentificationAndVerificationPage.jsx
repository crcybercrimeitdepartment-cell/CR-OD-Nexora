...
export default function VehicleChassisNumberIdentificationAndVerificationPage() {
  ...
  const title = VehicleChassisNumberIdentificationAndVerificationPage.moduleData.name;
  const description = VehicleChassisNumberIdentificationAndVerificationPage.moduleData.desc;
...
VehicleChassisNumberIdentificationAndVerificationPage.moduleData = {
  id: 'chassis-number',
  name: 'Vehicle Chassis Number Identification & Verification',
  desc: 'Decode VIN chassis records and manufacturer specs.',
  icon: (p) => <Settings {...p} />,

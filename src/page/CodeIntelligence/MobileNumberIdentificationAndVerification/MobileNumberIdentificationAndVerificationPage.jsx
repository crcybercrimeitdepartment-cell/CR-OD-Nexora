...
export default function MobileNumberIdentificationAndVerificationPage() {
  ...
  const title = MobileNumberIdentificationAndVerificationPage.moduleData.name;
  const description = MobileNumberIdentificationAndVerificationPage.moduleData.desc;
...
MobileNumberIdentificationAndVerificationPage.moduleData = {
  id: 'mobile-number',
  name: 'Mobile Number Identification & Verification',
  desc: 'Identify and verify mobile numbers and subscriber details.',
  icon: (p) => <PhoneCall {...p} />,
  color: 'text-blue-500',
  bg: 'bg-blue-50'
};

...
export default function EmailAddressIdentificationAndVerificationPage() {
  ...
  const title = EmailAddressIdentificationAndVerificationPage.moduleData.name;
  const description = EmailAddressIdentificationAndVerificationPage.moduleData.desc;
...
EmailAddressIdentificationAndVerificationPage.moduleData = {
  id: 'email-address',
  name: 'Email Address Identification & Verification',
  desc: 'Validate email domains, deliverability, and OSINT records.',
  icon: (p) => <Mail {...p} />,
  color: 'text-teal-500',
  bg: 'bg-teal-50'
};

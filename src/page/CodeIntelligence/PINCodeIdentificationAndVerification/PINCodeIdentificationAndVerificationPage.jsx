...
export default function PINCodeIdentificationAndVerificationPage() {
  ...
  const title = PINCodeIdentificationAndVerificationPage.moduleData.name;
  const description = PINCodeIdentificationAndVerificationPage.moduleData.desc;
...
PINCodeIdentificationAndVerificationPage.moduleData = {
  id: 'pin-code',
  name: 'PIN Code Identification & Verification',
  desc: 'Map demographic and geographic postal intelligence.',
  icon: (p) => <MapPin {...p} />,

...
export default function STDCodeAndAreaIdentificationAndVerificationPage() {
  ...
  const title = STDCodeAndAreaIdentificationAndVerificationPage.moduleData.name;
  const description = STDCodeAndAreaIdentificationAndVerificationPage.moduleData.desc;
...
STDCodeAndAreaIdentificationAndVerificationPage.moduleData = {
  id: 'std-code',
  name: 'STD Code & Area Identification & Verification',
  desc: 'Identify regional telecom areas and trunk dialing codes.',
  icon: (p) => <Phone {...p} />,
  color: 'text-blue-600',
  bg: 'bg-blue-50'
};

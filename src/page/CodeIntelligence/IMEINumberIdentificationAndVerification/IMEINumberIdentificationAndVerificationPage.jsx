...
export default function IMEINumberIdentificationAndVerificationPage() {
  ...
  const title = IMEINumberIdentificationAndVerificationPage.moduleData.name;
  const description = IMEINumberIdentificationAndVerificationPage.moduleData.desc;
...
IMEINumberIdentificationAndVerificationPage.moduleData = {
  id: 'imei-number',
  name: 'IMEI Number Identification & Verification',
  desc: 'Verify handset identity, manufacturer, and TAC details.',
  icon: (p) => <Cpu {...p} />,
  color: 'text-red-500',
  bg: 'bg-red-50'
};

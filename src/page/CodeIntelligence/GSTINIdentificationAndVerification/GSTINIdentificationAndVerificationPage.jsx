...
export default function GSTINIdentificationAndVerificationPage() {
  ...
  const title = GSTINIdentificationAndVerificationPage.moduleData.name;
  const description = GSTINIdentificationAndVerificationPage.moduleData.desc;
...
GSTINIdentificationAndVerificationPage.moduleData = {
  id: 'gstin',
  name: 'GSTIN Identification & Verification',
  desc: 'Verify Goods and Services Tax Identification Numbers.',
  icon: (p) => <Receipt {...p} />,
  color: 'text-teal-500',
  bg: 'bg-teal-50'
};

...
export default function PANNumberIdentificationAndVerificationPage() {
  ...
  const title = PANNumberIdentificationAndVerificationPage.moduleData.name;
  const description = PANNumberIdentificationAndVerificationPage.moduleData.desc;
...
PANNumberIdentificationAndVerificationPage.moduleData = {
  id: 'pan-number',
  name: 'PAN Number Identification & Verification',
  desc: 'Validate Permanent Account Numbers and taxpayer profile.',
  icon: (p) => <FileText {...p} />,

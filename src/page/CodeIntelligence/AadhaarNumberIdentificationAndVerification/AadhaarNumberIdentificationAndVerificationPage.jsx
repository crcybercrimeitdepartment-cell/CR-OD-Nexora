...
export default function AadhaarNumberIdentificationAndVerificationPage() {
  ...
  const title = AadhaarNumberIdentificationAndVerificationPage.moduleData.name;
  const description = AadhaarNumberIdentificationAndVerificationPage.moduleData.desc;
...
AadhaarNumberIdentificationAndVerificationPage.moduleData = {
  id: 'aadhaar-number',
  name: 'Aadhaar Number Identification & Verification',
  desc: 'Verify Aadhaar format, status, and linked demographic data.',
  icon: (p) => <UserCheck {...p} />,
  color: 'text-rose-500',
  bg: 'bg-rose-50'
};

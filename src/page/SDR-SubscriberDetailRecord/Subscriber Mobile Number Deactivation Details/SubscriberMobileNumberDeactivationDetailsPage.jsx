...
export function Header({ title, description }) {
  const displayTitle = title || "Subscriber Mobile Number Deactivation Details";
  const displayDesc = description || "View deactivation details of subscriber mobile numbers.";
...
export default function SubscriberMobileNumberDeactivationDetailsPage({ onBack }) {

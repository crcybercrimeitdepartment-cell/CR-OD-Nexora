...
import MCAIPage from "./MCAI-MinistryofCorporateAffairsRecordIntelligence";
import GSTRIPage from "./GSTRI-GoodsAndServicesTaxRecordIntelligence";
import ISORIPage from "./ISORI-ISORegistrationIntelligence";
import SRIPage from "./SRI-SocietyRegistrationIntelligence";
import TRIPage from "./TRI-TrustRegistrationIntelligence";
import Page12ARIPage from "./12ARI-12ARegistrationIntelligence";
import Page80GRIPage from "./80GRI-80GRegistrationIntelligence";
import URIPage from "./URI-UdyamRegistrationIntelligence";
import SIRIPage from "./SIRI-StartupIndiaRegistrationIntelligence";
import IECIPage from "./IECI-ImportExportCodeRegistrationIntelligence";
import FSSAIIPage from "./FSSAII-FoodSafetyandStandardsAuthorityofIndiaRegistrationIntelligence";
import DLIPage from "./DLI-DrugLicenseRegistrationIntelligence";
import FLIPage from "./FLI-FactoryLicenseRegistrationIntelligence";
import TLIPage from "./TLI-TradeLicenseRegistrationIntelligence";
import SERIPage from "./SERI-Shop&EstablishmentRegistrationIntelligence";
import FCRAIPage from "./FCRAI-ForeignContributionRegulationActRegistrationIntelligence";
import PANIPage from "./PANI-PermanentAccountNumberRegistrationIntelligence";
import TANIPage from "./TANI-TaxDeductionandCollectionAccountNumberRegistrationIntelligence";
import EPFOIPage from "./EPFOI-EmployeesProvidentFundOrganisationRegistrationIntelligence";
import ESICIPage from "./ESICI-EmployeesStateInsuranceCorporationRegistrationIntelligence";
import NSICIPage from "./NSICI-NationalSmallIndustriesCorporationRegistrationIntelligence";
import GeMRIPage from "./GeMRI-Governmente-MarketplaceRegistrationIntelligence";
import NGODIPage from "./NGODI-NGODARPANRegistrationIntelligence";
import CSR1IPage from "./CSR1I-CorporateSocialResponsibility(CSR-1)RegistrationIntelligence";
import TMRIPage from "./TMRI-TrademarkRegistrationIntelligence";
import FNOCIPage from "./FNOCI-FireNoObjectionCertificateRegistrationIntelligence";
import PCBIPage from "./PCBI-PollutionControlBoardRegistrationIntelligence";
import BISIPage from "./BISI-BureauofIndianStandardsRegistrationIntelligence";
import PESOIPage from "./PESOI-PetroleumandExplosivesSafetyOrganisationLicenseRegistrationIntelligence";
import LMRIPage from "./LMRI-LegalMetrologyRegistrationIntelligence";
import CERIPage from "./CERI-ClinicalEstablishmentRegistrationIntelligence";
import RERAIPage from "./RERAI-RealEstateRegulatoryAuthorityRegistrationIntelligence";

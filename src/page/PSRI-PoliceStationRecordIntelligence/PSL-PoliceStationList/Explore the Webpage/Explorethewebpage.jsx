...
import PoliceStationRecordReportPage from './POLICE STATION RECORD REPORT/PoliceStationRecordReportPage.jsx';
...
export default function Explorethewebpage({ activePage, setActivePage }) {
  ...
  const handleSearch = (e) => {
    ...
    const searchTerm = query.trim() || 'All Police Stations';
    ...
    return (
      <div className="relative w-full min-h-screen bg-transparent z-50">
        <button 
          ...
          className="absolute top-4 left-4 sm:top-6 sm:left-6 z-[100] flex items-center justify-center gap-2 bg-white/90 px-4 py-2 rounded-full shadow-md backdrop-blur-md border border-slate-200/90 transition-all hover:shadow-lg hover:scale-105 text-[#1e2a52] font-bold text-sm"
        >

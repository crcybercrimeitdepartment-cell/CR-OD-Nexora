...
import IPDRMPage from './IPDRMapping';
import GAPage from './GeoAnalysis';
import CMNPage from './CommonMobileNumbersIMEICellIDsDestinationIPDestinationPort';
import CWSMPage from './CompareWithSuspectMobileNumbersIMEICellIDsDestinationIPGroup';
import IBPNPage from './IdentifyBPartyNumbers';
import IPDRRPage from './IPDRRequisition';
import CWIPPage from './CountryWiseIPs';
import UMNPage from './UncommonMissingNumbers';
import SAPage from './SplitAnalysis';
import IPDRD1Page from './IPDR-DEMO_1';
import IPDRD2Page from './IPDR-DEMO_2';

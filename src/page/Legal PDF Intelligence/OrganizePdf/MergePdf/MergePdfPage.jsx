/**
 * @file src/page/LegalPdfIntelligence/OrganizePdf/MergePdf/MergePdfPage.jsx
 * @description Merge PDF page component.
 */
...
export default function MergePdfPage({ onBack }) {
  return (
    <section aria-labelledby="mergepdf-title" className="flex flex-col gap-6 sm:gap-7">
      <header className="relative pb-2 sm:pb-3">
        ...
        <div className="mt-7 text-center md:mt-0 md:px-28">
          <h1 id="mergepdf-title" className="text-3xl font-black leading-tight tracking-tight text-[#1e2a52] sm:text-4xl lg:text-5xl">
            Merge PDF
          </h1>

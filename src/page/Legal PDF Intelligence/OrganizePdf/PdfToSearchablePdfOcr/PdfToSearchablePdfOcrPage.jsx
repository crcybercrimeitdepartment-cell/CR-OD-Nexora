/**
 * @file src/page/LegalPdfIntelligence/OrganizePdf/PdfToSearchablePdfOcr/PdfToSearchablePdfOcrPage.jsx
 * @description PDF to Searchable PDF (OCR) page component.
 */
      ...
      <header className="relative pb-2 sm:pb-3">
        ...
        <div className="mt-7 text-center md:mt-0 md:px-28">
          ...
          <p className="mx-auto mt-4 max-w-3xl text-sm font-semibold leading-relaxed text-slate-700 sm:text-base">
            Make text inside image PDFs searchable and selectable via OCR engines
          </p>
        </div>
      </header>
    </section>

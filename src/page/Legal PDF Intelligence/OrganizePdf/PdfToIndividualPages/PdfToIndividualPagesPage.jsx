/**
 * @file src/page/LegalPdfIntelligence/OrganizePdf/PdfToIndividualPages/PdfToIndividualPagesPage.jsx
 * @description PDF to Individual Pages page component.
 */
      ...
      <header className="relative pb-2 sm:pb-3">
        ...
        <div className="mt-7 text-center md:mt-0 md:px-28">
          ...
          <p className="mx-auto mt-4 max-w-3xl text-sm font-semibold leading-relaxed text-slate-700 sm:text-base">
            Split your entire PDF document into separate single-page PDF files
          </p>
        </div>
      </header>
    </section>

/**
 * @file src/page/LegalPdfIntelligence/OrganizePdf/EditPdf/EditPdfPage.jsx
 * @description Edit PDF page component.
 */
import React from 'react';
import { ArrowLeft } from 'lucide-react';

export default function EditPdfPage({ onBack }) {
  return (
    <section aria-labelledby="editpdf-title" className="flex flex-col gap-6 sm:gap-7">
      <header className="relative pb-2 sm:pb-3">
        ...
        <div className="mt-7 text-center md:mt-0 md:px-28">
          <h1 id="editpdf-title" className="text-3xl font-black leading-tight tracking-tight text-[#1e2a52] sm:text-4xl lg:text-5xl">
            Edit PDF
          </h1>
          <p className="mx-auto mt-4 max-w-3xl text-sm font-semibold leading-relaxed text-slate-700 sm:text-base">
            Add text, drawings, shapes, and images directly onto PDF pages
          </p>
        </div>
      </header>
    </section>

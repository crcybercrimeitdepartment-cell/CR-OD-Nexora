/**
 * @file src/page/LegalPdfIntelligence/CompareAndRedaction/DemoTool1/DemoTool1Page.jsx
    ...
    <section aria-labelledby="demotool1-title" className="flex flex-col gap-6 sm:gap-7">
      <header className="relative pb-2 sm:pb-3">
        ...
        <div className="mt-7 text-center md:mt-0 md:px-28">
          ...
          <p className="mx-auto mt-4 max-w-3xl text-sm font-semibold leading-relaxed text-slate-700 sm:text-base">
            Perform Demo Tool 1 processing and compare/redaction workflows.
          </p>
        </div>
      </header>
      ...
      <div className="mx-auto w-full max-w-4xl rounded-3xl border border-slate-200 bg-white p-6 shadow-xl sm:p-8">
        <div className="flex flex-col items-center justify-center border-2 border-dashed border-slate-300 rounded-2xl p-10 text-center bg-slate-50/50 hover:bg-slate-50 transition">
          <FileSearch className="h-16 w-16 text-blue-600 mb-4 animate-bounce" />
          <h3 className="text-xl font-bold text-slate-900 mb-2">Upload PDF Document</h3>
          <p className="text-sm text-slate-600 mb-6 max-w-md">
            Drag and drop your PDF document here, or browse local files to execute Demo Tool 1.
          </p>
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="p-4 rounded-xl border border-slate-200 bg-slate-50">
            <div className="flex items-center gap-2 font-bold text-slate-800 mb-2">
              <Settings className="h-4 w-4 text-indigo-600" /> Comparison Settings
            </div>
            <p className="text-xs text-slate-600">Configure parameters for Demo Tool 1.</p>
          </div>
          <div className="p-4 rounded-xl border border-slate-200 bg-slate-50">
            <div className="flex items-center gap-2 font-bold text-slate-800 mb-2">
              <ShieldCheck className="h-4 w-4 text-emerald-600" /> Audit Log
            </div>
            <p className="text-xs text-slate-600">Generate detailed audit logs and report parameters.</p>
          </div>
        </div>
      </div>
    </section>

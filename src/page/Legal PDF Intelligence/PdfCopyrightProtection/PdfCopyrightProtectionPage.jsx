...
import AIContentSimilarityCheckPage from './AI Content Similarity Check/AIContentSimilarityCheckPage';
import AuthorVerificationPage from './Author Verification/AuthorVerificationPage';
import BlockchainCopyrightRegistrationPage from './Blockchain Copyright Registration/BlockchainCopyrightRegistrationPage';
import BlockchainOwnershipVerificationPage from './Blockchain Ownership Verification/BlockchainOwnershipVerificationPage';
import ContentOwnershipValidationPage from './Content Ownership Validation/ContentOwnershipValidationPage';
import CopyrightAuditTrailPage from './Copyright Audit Trail/CopyrightAuditTrailPage';
import CopyrightClaimReportPage from './Copyright Claim Report/CopyrightClaimReportPage';
import CopyrightComplianceReportPage from './Copyright Compliance Report/CopyrightComplianceReportPage';
import CopyrightEvidenceReportPage from './Copyright Evidence Report/CopyrightEvidenceReportPage';
import CopyrightExpirationTrackingPage from './Copyright Expiration Tracking/CopyrightExpirationTrackingPage';
import CopyrightHistoryPage from './Copyright History/CopyrightHistoryPage';
import CopyrightHolderManagementPage from './Copyright Holder Management/CopyrightHolderManagementPage';
import CopyrightInformationEditorPage from './Copyright Information Editor/CopyrightInformationEditorPage';
import CopyrightInfringementDetectionPage from './Copyright Infringement Detection/CopyrightInfringementDetectionPage';
import CopyrightMetadataManagementPage from './Copyright Metadata Management/CopyrightMetadataManagementPage';
import CopyrightNoticePage from './Copyright Notice/CopyrightNoticePage';
import CopyrightPolicyTemplatesPage from './Copyright Policy Templates/CopyrightPolicyTemplatesPage';
import CopyrightRegistrationPage from './Copyright Registration/CopyrightRegistrationPage';
import CopyrightRenewalReminderPage from './Copyright Renewal Reminder/CopyrightRenewalReminderPage';
import CopyrightRevocationRecordPage from './Copyright Revocation Record/CopyrightRevocationRecordPage';
import CopyrightTransferManagementPage from './Copyright Transfer Management/CopyrightTransferManagementPage';
import CopyrightWatermarkPage from './Copyright Watermark/CopyrightWatermarkPage';
import DigitalCopyrightSealPage from './Digital Copyright Seal/DigitalCopyrightSealPage';
import DocumentOwnershipVerificationPage from './Document Ownership Verification/DocumentOwnershipVerificationPage';
import DocumentProvenanceTrackingPage from './Document Provenance Tracking/DocumentProvenanceTrackingPage';
import DuplicateContentDetectionPage from './Duplicate Content Detection/DuplicateContentDetectionPage';
import InvisibleCopyrightWatermarkPage from './Invisible Copyright Watermark/InvisibleCopyrightWatermarkPage';
import LicenseManagementPage from './License Management/LicenseManagementPage';
import LicenseVerificationPage from './License Verification/LicenseVerificationPage';
import OwnershipCertificatePage from './Ownership Certificate/OwnershipCertificatePage';
import PublisherInformationPage from './Publisher Information/PublisherInformationPage';
import UsageRightsManagementPage from './Usage Rights Management/UsageRightsManagementPage';
/**
 * @file PDFCopyrightProtection.jsx
...
export function PDFCopyrightProtection({ tool, index = 0, onClick }) {
  ...
  return (
    ...
    >
      ...
      <div className="w-8 h-10 sm:w-[52px] sm:h-[60px] shrink-0 relative flex items-center justify-center group-hover:scale-108 transition-transform duration-200 filter drop-shadow-[0_4px_10px_rgba(0,0,0,0.06)] mt-0.5">
...
export function PDFCopyrightProtectionPage({ onBack, searchQuery = "" }) {
  ...
  if (selectedTool) {
    ...
    if (selectedTool.id === 'copyright-compliance-report') {
      return <CopyrightComplianceReportPage tool={selectedTool} onBack={handleBack} />;
    }
...
export default PDFCopyrightProtectionPage;

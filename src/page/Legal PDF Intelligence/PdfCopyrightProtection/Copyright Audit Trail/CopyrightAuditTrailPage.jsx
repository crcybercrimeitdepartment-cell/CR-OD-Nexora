...
export default function CopyrightAuditTrailPage({ tool, onBack }) {
  ...
  const loadEvents = async () => {
    ...
    try {
      const r = await fetch('/api/pdf-copyright-protection/audit-trail/get-events', { method: 'POST', body: fd });
  ...
  const generateReport = async () => {
    ...
    try {
      ...
      const r = await fetch('/api/pdf-copyright-protection/audit-trail/report', { method: 'POST', body: fd });
      const d = await r.json();

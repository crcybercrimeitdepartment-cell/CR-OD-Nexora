...
export default function CopyrightTransferManagementPage({ tool, onBack }) {
  ...
  const loadOwner = async () => {
    ...
    try {
      ...
      const r = await fetch('/api/pdf-copyright-protection/transfer/get-current-owner', { method: 'POST', body: fd });
  ...
  const loadHistory = async (fd) => {
    try {
      const r = await fetch('/api/pdf-copyright-protection/transfer/history', { method: 'POST', body: fd });
      const d = await r.json();
  ...
  const confirmTransfer = async () => {
    ...
    try {
      ...
      const r = await fetch('/api/pdf-copyright-protection/transfer/execute', { method: 'POST', body: fd });
      const d = await r.json();
  ...
  const downloadReport = async () => {
    ...
    try {
      ...
      const r = await fetch('/api/pdf-copyright-protection/transfer/report', { method: 'POST', body: fd });
      const d = await r.json();

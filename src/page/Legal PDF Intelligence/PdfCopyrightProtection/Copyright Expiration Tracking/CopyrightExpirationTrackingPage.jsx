...
export default function CopyrightExpirationTrackingPage({ tool, onBack }) {
  ...
  const handleProcess = async () => {
    ...
    try {
      const r = await fetch('/api/pdf-copyright-protection/expiration/track', { method: 'POST', body: fd });
  ...
  const downloadReport = async () => {
    ...
    try {
      ...
      const r = await fetch('/api/pdf-copyright-protection/expiration/report', { method: 'POST', body: fd });
      const d = await r.json();

...
export default function CopyrightRevocationRecordPage({ tool, onBack }) {
  ...
  const loadRecord = async () => {
    ...
    try {
      ...
      const r = await fetch('/api/pdf-copyright-protection/revocation/get-record', { method: 'POST', body: fd });
  ...
  const loadHistory = async (fd) => {
    try {
      const r = await fetch('/api/pdf-copyright-protection/revocation/history', { method: 'POST', body: fd });
      const d = await r.json();
  ...
  const confirmRevocation = async () => {
    ...
    try {
      ...
      const r = await fetch('/api/pdf-copyright-protection/revocation/record', { method: 'POST', body: fd });
      const d = await r.json();
  ...
  const downloadReport = async () => {
    ...
    try {
      ...
      const r = await fetch('/api/pdf-copyright-protection/revocation/report', { method: 'POST', body: fd });
      const d = await r.json();

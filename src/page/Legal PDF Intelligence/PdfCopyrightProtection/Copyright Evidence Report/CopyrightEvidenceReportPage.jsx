...
export default function CopyrightEvidenceReportPage({ tool, onBack }) {
  ...
  const handleProcess = async () => {
    ...
    try {
      const r = await fetch('/api/pdf-copyright-protection/evidence-report/collect', { method: 'POST', body: fd });
  ...
  const downloadReport = async () => {
    ...
    try {
      ...
      const r = await fetch('/api/pdf-copyright-protection/evidence-report/generate', { method: 'POST', body: fd });
      const d = await r.json();

...
export default function DigitalCopyrightSealPage({ tool, onBack }) {
  ...
  const generate = async (e) => {
    ...
    try {
      ...
      const r = await fetch('/api/pdf-copyright-protection/digital-seal/generate', { method: 'POST', body: fd });
  ...
  const verifySeal = async (file) => {
    ...
    try {
      ...
      const r = await fetch('/api/pdf-copyright-protection/digital-seal/verify', { method: 'POST', body: fd });
      const j = await r.json();
          ...
          {genResult && (
            <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-4">
                <a href={genResult.downloadUrl} download

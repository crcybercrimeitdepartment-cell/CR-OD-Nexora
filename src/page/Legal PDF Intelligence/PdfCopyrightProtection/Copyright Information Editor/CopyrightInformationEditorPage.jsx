...
export default function CopyrightInformationEditorPage({ tool, onBack }) {
  ...
  const readCopyrightInfo = async (selectedFile) => {
    ...
    try {
      const res = await fetch('/api/pdf-copyright-protection/information-editor/read', { method: 'POST', body: fd });
  ...
  const submitUpdate = async (e) => {
    ...
    try {
      const res = await fetch('/api/pdf-copyright-protection/information-editor/update', { method: 'POST', body: fd });
      const data = await res.json();

...
export default function OwnershipCertificatePage({ tool, onBack }) {
  ...
  const generate = async (e) => {
    ...
    try {
      ...
      const r = await fetch('/api/pdf-copyright-protection/ownership-certificate/generate', { method: 'POST', body: fd });
        ...
        {result && (
          <div className="bg-white rounded-3xl border border-slate-200/80 shadow-[0_8px_30px_rgba(0,0,0,0.04)] p-6 sm:p-10 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <a href={result.downloadUrl} download className="bg-orange-500 hover:bg-orange-600 text-white px-8 py-3.5 rounded-full font-bold shadow-md transition-all text-sm cursor-pointer inline-flex justify-center items-center gap-2 hover:scale-105 active:scale-95 w-full sm:w-auto">

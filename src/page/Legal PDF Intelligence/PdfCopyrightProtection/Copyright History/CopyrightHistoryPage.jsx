...
export default function CopyrightHistoryPage({ tool, onBack }) {
  ...
  const loadHistory = async () => {
    ...
    try {
      const r = await fetch('/api/pdf-copyright-protection/history/get-history', { method: 'POST', body: fd });
  ...
  const generateReport = async () => {
    ...
    try {
      ...
      const r = await fetch('/api/pdf-copyright-protection/history/report', { method: 'POST', body: fd });
      const d = await r.json();

...
export function FingerprintAuthenticationBiometricSignature({ tool, index = 0, onClick }) {
  ...
  return (
    ...
    >
      ...
      <div className="w-8 h-10 sm:w-[52px] sm:h-[60px] shrink-0 relative flex items-center justify-center group-hover:scale-108 transition-transform duration-200 mt-0.5" style={{ filter: "drop-shadow(0 4px 10px rgba(0,0,0,0.06))" }}>
...
export default FingerprintAuthenticationBiometricSignaturePage;

...
import ICRDPage from './InputCDRRawData';
import GRPage from './GeneralReport';
import MRPage from './MappingReport';
import ARPage from './AnalysisReport';
import PRPage from './PeriodicReport';
import ADRPage from './AdditionalReport';
import GAPage from './GeoAnalysis';
import MCPage from './MixedCalls';
import FSDPage from './FilterSplitData';
import OUPPage from './OffUnusedPeriod';
import NMNPage from './NewMissingNumbers';
import CNPage from './CommonNumbers';
import CDRTOCDRCELLPage from './CDRtoCDRCellsXYAxisReports';
import CDRTOWERIPDRILDPage from './CDRTowerDumpIPDRILDCommonNumbers';
import CRSPage from './CDRReportSummary';
import CWSMPage from './CompareWithSuspectMobileNumbersIMEICellIDsGroups';
import CPAPage from './CDRPatternAnalysis';
import CLMAPage from './CDRLastMonthAnalysis';
import CSAPage from './CDRSplitAnalysis';
import CDRD1Page from './CDR-DEMO_1';
import CDRD2Page from './CDR-DEMO_2';
import CDRD3Page from './CDR-DEMO_3';
import CDRD4Page from './CDR-DEMO_4';
import CDRD5Page from './CDR-DEMO_5';
...
export default function CDRPage({ onBack }) {
  const { dynamicGridClass, displayTools } = usePageLayout('cdr', CDR_TOOLS);

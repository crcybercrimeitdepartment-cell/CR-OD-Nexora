...
const tools = [
  ["EBI", "Electricity Bill Intelligence"],
  ["LPGRI", "LPG Record Intelligence"],
  ["PIM", "Passport Intelligence Module"],
  ["PANI", "PAN Intelligence"],
  ["VII", "Voter ID Intelligence"],
  ["RCI", "Residence Certificate Intelligence"],
...
const dir = path.join(__dirname, 'kycdi');
...
console.log("Files updated in kycdi/");

...
import SCIPage from "./SCI-SupremeCourtInformation/SCI-SupremeCourtInformationPage";
import HCIPage from "./HCI-HighCourtInformation/HCI-HighCourtInformationPage";
import DCIPage from "./DCI-DistrictCourtInformation/DCI-DistrictCourtInformationPage";
import FCIPage from "./FCI-FamilyCourtInformation/FCI-FamilyCourtInformationPage";
import CCIPage from "./CCI-CivilCourtInformation/CCI-CivilCourtInformationPage";
import CrCIPage from "./CrCI-CriminalCourtInformation/CrCI-CriminalCourtInformationPage";
import ComCIPage from "./ComCI-CommercialCourtInformation/ComCI-CommercialCourtInformationPage";
import ConCIPage from "./ConCI-ConsumerCourtInformation/ConCI-ConsumerCourtInformationPage";
import SpCIPage from "./SpCI-SpecialCourtInformation/SpCI-SpecialCourtInformationPage";
import TIPage from "./TI-TribunalInformation/TI-TribunalInformationPage";
import FTCIPage from "./FTCI-FastTrackCourtInformation/FTCI-FastTrackCourtInformationPage";
import LAIPage from "./LAI-LokAdalatInformation/LAI-LokAdalatInformationPage";
import GNIPage from "./GNI-GramNyayalayaInformation/GNI-GramNyayalayaInformationPage";
import CpxIPage from "./CpxI-CourtComplexInformation/CpxI-CourtComplexInformationPage";
import COLPage from "./COL-CollectorOfficeList/COL-CollectorOfficeListPage";
import SCOLPage from "./SCOL-SubCollectorOfficeList/SCOL-SubCollectorOfficeListPage";
import TOLPage from "./TOL-TahasildarOfficeList/TOL-TahasildarOfficeListPage";
import BDOLPage from "./BDOL-BlockDevelopmentOfficeList/BDOL-BlockDevelopmentOfficeListPage";
import RIOLPage from "./RIOL-RevenueInspectorOfficeList/RIOL-RevenueInspectorOfficeListPage";
import RCOLPage from "./RCOL-RevenueCircleOfficeList/RCOL-RevenueCircleOfficeListPage";
import GPOLPage from "./GPOL-GramPanchayatOfficeList/GPOL-GramPanchayatOfficeListPage";
import PSOLPage from "./PSOL-PanchayatSamitiOfficeList/PSOL-PanchayatSamitiOfficeListPage";
import ZPOLPage from "./ZPOL-ZillaParishadOfficeList/ZPOL-ZillaParishadOfficeListPage";
import MOLPage from "./MOL-MunicipalityOfficeList/MOL-MunicipalityOfficeListPage";
import MCOLPage from "./MCOL-MunicipalCorporationOfficeList/MCOL-MunicipalCorporationOfficeListPage";
import NACOLPage from "./NACOL-NotifiedAreaCouncilOfficeList/NACOL-NotifiedAreaCouncilOfficeListPage";
import DRDAOLPage from "./DRDAOL-DistrictRuralDevelopmentAgencyOfficeList/DRDAOL-DistrictRuralDevelopmentAgencyOfficeListPage";
import SROLPage from "./SROL-SubRegistrarOfficeList/SROL-SubRegistrarOfficeListPage";

...
import SCIPage from "./SCI-SupremeCourtInformation";
import HCIPage from "./HCI-HighCourtInformation";
import DCIPage from "./DCI-DistrictCourtInformation";
import FCIPage from "./FCI-FamilyCourtInformation";
import CCIPage from "./CCI-CivilCourtInformation";
import CrCIPage from "./CrCI-CriminalCourtInformation";
import ComCIPage from "./ComCI-CommercialCourtInformation";
import ConCIPage from "./ConCI-ConsumerCourtInformation";
import SpCIPage from "./SpCI-SpecialCourtInformation";
import TIPage from "./TI-TribunalInformation";
import FTCIPage from "./FTCI-FastTrackCourtInformation";
import LAIPage from "./LAI-LokAdalatInformation";
import GNIPage from "./GNI-GramNyayalayaInformation";
import CpxIPage from "./CpxI-CourtComplexInformation";
import COLPage from "./COL-CollectorOfficeList";
import SCOLPage from "./SCOL-SubCollectorOfficeList";
import TOLPage from "./TOL-TahasildarOfficeList";
import BDOLPage from "./BDOL-BlockDevelopmentOfficeList";
import RIOLPage from "./RIOL-RevenueInspectorOfficeList";
import RCOLPage from "./RCOL-RevenueCircleOfficeList";
import GPOLPage from "./GPOL-GramPanchayatOfficeList";
import PSOLPage from "./PSOL-PanchayatSamitiOfficeList";
import ZPOLPage from "./ZPOL-ZillaParishadOfficeList";
import MOLPage from "./MOL-MunicipalityOfficeList";
import MCOLPage from "./MCOL-MunicipalCorporationOfficeList";
import NACOLPage from "./NACOL-NotifiedAreaCouncilOfficeList";
import DRDAOLPage from "./DRDAOL-DistrictRuralDevelopmentAgencyOfficeList";
import SROLPage from "./SROL-SubRegistrarOfficeList";

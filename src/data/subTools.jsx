...
export const ABOUTUS_TOOLS = [
  { parentId: 'AboutUs', id: 'au1', name: 'Introduction to NEXORA', fullName: 'Introduction to NEXORA', desc: 'Overview of the NEXORA platform and its mission in forensic intelligence.', icon: (p) => <Info {...p} />, color: 'text-blue-600', bg: 'bg-blue-100' },
  { parentId: 'AboutUs', id: 'au2', name: 'Purpose of NEXORA', fullName: 'Purpose of NEXORA', desc: 'Primary goals and the driving force behind the platform creation.', icon: (p) => <Target {...p} />, color: 'text-indigo-600', bg: 'bg-indigo-100' },
  { parentId: 'AboutUs', id: 'au3', name: 'Objectives of NEXORA', fullName: 'Objectives of NEXORA', desc: 'Key targets and milestones for NEXORA intelligence capabilities.', icon: (p) => <Crosshair {...p} />, color: 'text-rose-600', bg: 'bg-rose-100' },
  { parentId: 'AboutUs', id: 'au4', name: 'Vision of NEXORA', fullName: 'Vision of NEXORA', desc: 'Long-term goals for revolutionizing law enforcement analytics.', icon: (p) => <Eye {...p} />, color: 'text-sky-600', bg: 'bg-sky-100' },
  { parentId: 'AboutUs', id: 'au5', name: 'Mission of NEXORA', fullName: 'Mission of NEXORA', desc: 'Our commitment to securing data and providing actionable intelligence.', icon: (p) => <Flag {...p} />, color: 'text-emerald-600', bg: 'bg-emerald-100' },
  { parentId: 'AboutUs', id: 'au6', name: 'Core Values of NEXORA', fullName: 'Core Values of NEXORA', desc: 'The fundamental principles of integrity, security, and innovation.', icon: (p) => <Star {...p} />, color: 'text-amber-600', bg: 'bg-amber-100' },
  { parentId: 'AboutUs', id: 'au7', name: 'History of NEXORA', fullName: 'History of NEXORA', desc: 'The journey and evolution of the NEXORA intelligence platform.', icon: (p) => <History {...p} />, color: 'text-purple-600', bg: 'bg-purple-100' },
  { parentId: 'AboutUs', id: 'au8', name: 'Key Features of NEXORA', fullName: 'Key Features of NEXORA', desc: 'Highlighting the standout functionalities and tools available.', icon: (p) => <Key {...p} />, color: 'text-teal-600', bg: 'bg-teal-100' },
  { parentId: 'AboutUs', id: 'au9', name: 'Core Intelligence Modules of NEXORA', fullName: 'Core Intelligence Modules of NEXORA', desc: 'Deep dive into the 40+ specialized intelligence and record modules.', icon: (p) => <Layers {...p} />, color: 'text-cyan-600', bg: 'bg-cyan-100' },
  { parentId: 'AboutUs', id: 'au10', name: 'Investigation Capabilities of NEXORA', fullName: 'Investigation Capabilities of NEXORA', desc: 'Comprehensive tools for tracking, correlating, and analyzing data.', icon: (p) => <Search {...p} />, color: 'text-violet-600', bg: 'bg-violet-100' },
  { parentId: 'AboutUs', id: 'au11', name: 'Technology Stack of NEXORA', fullName: 'Technology Stack of NEXORA', desc: 'The robust architecture and modern tech stack powering the system.', icon: (p) => <Cpu {...p} />, color: 'text-blue-600', bg: 'bg-blue-100' },
  { parentId: 'AboutUs', id: 'au12', name: 'Security Framework of NEXORA', fullName: 'Security Framework of NEXORA', desc: 'Advanced encryption, auditing, and compliance protocols.', icon: (p) => <Shield {...p} />, color: 'text-green-600', bg: 'bg-green-100' },
  { parentId: 'AboutUs', id: 'au13', name: 'AI & Analytics in NEXORA', fullName: 'AI & Analytics in NEXORA', desc: 'How artificial intelligence drives predictive analytics and mapping.', icon: (p) => <Brain {...p} />, color: 'text-fuchsia-600', bg: 'bg-fuchsia-100' },
  { parentId: 'AboutUs', id: 'au14', name: 'Search & Intelligence Engine', fullName: 'Search & Intelligence Engine', desc: 'The core engine for global search and entity correlation.', icon: (p) => <Search {...p} />, color: 'text-orange-600', bg: 'bg-orange-100' },
  { parentId: 'AboutUs', id: 'au15', name: 'Reporting & Visualization', fullName: 'Reporting & Visualization', desc: 'Generating court-admissible reports and dynamic data visualizations.', icon: (p) => <BarChart {...p} />, color: 'text-rose-600', bg: 'bg-rose-100' },
  { parentId: 'AboutUs', id: 'au16', name: 'Benefits of NEXORA', fullName: 'Benefits of NEXORA', desc: 'Advantages of using a unified intelligence hub for investigations.', icon: (p) => <TrendingUp {...p} />, color: 'text-emerald-600', bg: 'bg-emerald-100' },
  { parentId: 'AboutUs', id: 'au17', name: 'Target Users of NEXORA', fullName: 'Target Users of NEXORA', desc: 'Designed for law enforcement, intelligence agencies, and analysts.', icon: (p) => <Users {...p} />, color: 'text-indigo-600', bg: 'bg-indigo-100' },
  { parentId: 'AboutUs', id: 'au18', name: 'Industries & Departments Served', fullName: 'Industries & Departments Served', desc: 'Sectors leveraging NEXORA for security and forensic analysis.', icon: (p) => <Building {...p} />, color: 'text-purple-600', bg: 'bg-purple-100' },
  { parentId: 'AboutUs', id: 'au19', name: 'Investigation Workflow', fullName: 'Investigation Workflow', desc: 'Step-by-step process from data ingestion to actionable insights.', icon: (p) => <GitMerge {...p} />, color: 'text-sky-600', bg: 'bg-sky-100' },
  { parentId: 'AboutUs', id: 'au20', name: 'System Integrations', fullName: 'System Integrations', desc: 'Seamlessly connecting with existing databases and external APIs.', icon: (p) => <Link {...p} />, color: 'text-teal-600', bg: 'bg-teal-100' },
  { parentId: 'AboutUs', id: 'au21', name: 'Scalability & Performance', fullName: 'Scalability & Performance', desc: 'Handling massive datasets with zero downtime and high availability.', icon: (p) => <Activity {...p} />, color: 'text-amber-600', bg: 'bg-amber-100' },
  { parentId: 'AboutUs', id: 'au22', name: 'Research & Innovation', fullName: 'Research & Innovation', desc: 'Continuous development of new forensic methodologies and tools.', icon: (p) => <Lightbulb {...p} />, color: 'text-yellow-600', bg: 'bg-yellow-100' },
  { parentId: 'AboutUs', id: 'au23', name: 'Future Roadmap of NEXORA', fullName: 'Future Roadmap of NEXORA', desc: 'Upcoming features, modules, and strategic plans for the platform.', icon: (p) => <Map {...p} />, color: 'text-cyan-600', bg: 'bg-cyan-100' },
  { parentId: 'AboutUs', id: 'au24', name: 'Why Choose NEXORA', fullName: 'Why Choose NEXORA', desc: 'What sets NEXORA apart from traditional intelligence solutions.', icon: (p) => <CheckCircle {...p} />, color: 'text-emerald-600', bg: 'bg-emerald-100' },
  { parentId: 'AboutUs', id: 'au25', name: 'Our Commitment', fullName: 'Our Commitment', desc: 'Our promise of reliability, confidentiality, and support.', icon: (p) => <Heart {...p} />, color: 'text-rose-600', bg: 'bg-rose-100' },
  { parentId: 'AboutUs', id: 'au26', name: 'Success Stories & Achievements', fullName: 'Success Stories & Achievements', desc: 'Real-world impact and case studies using NEXORA analytics.', icon: (p) => <Award {...p} />, color: 'text-amber-600', bg: 'bg-amber-100' },
  { parentId: 'AboutUs', id: 'au27', name: 'Partners & Collaborations', fullName: 'Partners & Collaborations', desc: 'Collaborations with global security and technology organizations.', icon: (p) => <Handshake {...p} />, color: 'text-indigo-600', bg: 'bg-indigo-100' },
  { parentId: 'AboutUs', id: 'au28', name: 'Certifications & Standards', fullName: 'Certifications & Standards', desc: 'Compliance with international data protection and security standards.', icon: (p) => <ShieldCheck {...p} />, color: 'text-blue-600', bg: 'bg-blue-100' },
  { parentId: 'AboutUs', id: 'au29', name: 'Support & Services', fullName: 'Support & Services', desc: 'Dedicated assistance, training, and enterprise deployment services.', icon: (p) => <LifeBuoy {...p} />, color: 'text-sky-600', bg: 'bg-sky-100' },
  { parentId: 'AboutUs', id: 'au30', name: 'Contact NEXORA', fullName: 'Contact NEXORA', desc: 'Get in touch for enterprise licensing, demos, and support.', icon: (p) => <Phone {...p} />, color: 'text-teal-600', bg: 'bg-teal-100' },
  { parentId: 'AboutUs', id: 'au31', name: 'About DEMO 1', fullName: 'About DEMO 1', desc: 'Interactive demonstration of NEXORA core capabilities.', icon: (p) => <PlayCircle {...p} />, color: 'text-purple-600', bg: 'bg-purple-100' },
  { parentId: 'AboutUs', id: 'au32', name: 'About DEMO 2', fullName: 'About DEMO 2', desc: 'Advanced scenario-based demonstration of intelligence workflows.', icon: (p) => <PlayCircle {...p} />, color: 'text-violet-600', bg: 'bg-violet-100' },
];
...
export const ACCOUNTSETTING_TOOLS = [
  ...
  { parentId: 'AccountSetting', id: 'as2', name: 'Personal Information', fullName: 'Personal Information', desc: 'Update contact email, phone number, address, and personal identity details.', icon: (p) => <UserCheck {...p} />, color: 'text-indigo-600', bg: 'bg-indigo-100' },
  { parentId: 'AccountSetting', id: 'as3', name: 'Organization Details', fullName: 'Organization Details', desc: 'View agency details, department affiliation, unit number, and official badge info.', icon: (p) => <Building2 {...p} />, color: 'text-emerald-600', bg: 'bg-emerald-100' },
  { parentId: 'AccountSetting', id: 'as4', name: 'Role & Permissions', fullName: 'Role & Permissions', desc: 'Review access levels, clearance tiers, security roles, and system capabilities.', icon: (p) => <ShieldCheck {...p} />, color: 'text-purple-600', bg: 'bg-purple-100' },
  { parentId: 'AccountSetting', id: 'as5', name: 'Security Settings', fullName: 'Security Settings', desc: 'Configure two-factor authentication (2FA), password changes, and security keys.', icon: (p) => <Lock {...p} />, color: 'text-rose-600', bg: 'bg-rose-100' },
  ...
  { parentId: 'AccountSetting', id: 'as12', name: 'Order History', fullName: 'Order History', desc: 'Track license requests, data purchases, and module expansion orders.', icon: (p) => <ShoppingCart {...p} />, color: 'text-orange-600', bg: 'bg-orange-100' },
  ...
  { parentId: 'AccountSetting', id: 'as14', name: 'Data Export', fullName: 'Data Export', desc: 'Export account archives, activity logs, and evidence records in CSV/PDF format.', icon: (p) => <FileText {...p} />, color: 'text-green-600', bg: 'bg-green-100' },
  ...
  { parentId: 'AccountSetting', id: 'as17', name: 'Audit Logs', fullName: 'Audit Logs', desc: 'Comprehensive, tamper-proof security audit log of all account transactions.', icon: (p) => <FileCheck {...p} />, color: 'text-emerald-600', bg: 'bg-emerald-100' },
  ...
  { parentId: 'AccountSetting', id: 'as19', name: 'Notifications', fullName: 'Notifications', desc: 'Set alert preferences, email notifications, SMS alerts, and push updates.', icon: (p) => <MessageSquare {...p} />, color: 'text-sky-600', bg: 'bg-sky-100' },
  { parentId: 'AccountSetting', id: 'as20', name: 'Language & Region', fullName: 'Language & Region', desc: 'Select interface language, date/time formats, and regional time zones.', icon: (p) => <Globe {...p} />, color: 'text-blue-600', bg: 'bg-blue-100' },
  { parentId: 'AccountSetting', id: 'as21', name: 'Appearance', fullName: 'Appearance', desc: 'Customize theme mode, UI scaling, font sizes, and layout preferences.', icon: (p) => <Moon {...p} />, color: 'text-indigo-600', bg: 'bg-indigo-100' },
  { parentId: 'AccountSetting', id: 'as22', name: 'Privacy Settings', fullName: 'Privacy Settings', desc: 'Control data visibility, telemetry collection, and confidential mode toggles.', icon: (p) => <Eye {...p} />, color: 'text-rose-600', bg: 'bg-rose-100' },
  { parentId: 'AccountSetting', id: 'as23', name: 'Invite Team', fullName: 'Invite Team', desc: 'Invite team members, send collaboration links, and manage department seats.', icon: (p) => <UserPlus {...p} />, color: 'text-emerald-600', bg: 'bg-emerald-100' },
  { parentId: 'AccountSetting', id: 'as24', name: 'Support Center', fullName: 'Support Center', desc: 'Submit support tickets, view documentation guides, and talk to technical support.', icon: (p) => <LifeBuoy {...p} />, color: 'text-teal-600', bg: 'bg-teal-100' },
  { parentId: 'AccountSetting', id: 'as25', name: 'Legal Information', fullName: 'Legal Information', desc: 'Review terms of service, compliance framework, and forensic data disclosures.', icon: (p) => <Gavel {...p} />, color: 'text-cyan-600', bg: 'bg-cyan-100' },
  ...
  { parentId: 'AccountSetting', id: 'as27', name: 'Logout', fullName: 'Logout', desc: 'Securely terminate the current session and sign out of the NEXORA platform.', icon: (p) => <Shuffle {...p} />, color: 'text-orange-600', bg: 'bg-orange-100' },
  { parentId: 'AccountSetting', id: 'as28', name: 'Account Setting demo_1', fullName: 'Account Setting demo_1', desc: 'Preview of upcoming account configuration and security features.', icon: (p) => <PlayCircle {...p} />, color: 'text-purple-600', bg: 'bg-purple-100' },
];

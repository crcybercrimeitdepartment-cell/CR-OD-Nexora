...
export const ABOUTUS_TOOLS = [
  ...
  { parentId: 'AboutUs', id: 'au2', name: 'Purpose of NEXORA', fullName: 'Purpose of NEXORA', desc: 'Purpose of NEXORA module details and configuration.', icon: (p) => <Target {...p} />, color: 'text-indigo-600', bg: 'bg-indigo-100' },
  { parentId: 'AboutUs', id: 'au3', name: 'Objectives of NEXORA', fullName: 'Objectives of NEXORA', desc: 'Objectives of NEXORA module details and configuration.', icon: (p) => <Crosshair {...p} />, color: 'text-rose-600', bg: 'bg-rose-100' },
  { parentId: 'AboutUs', id: 'au4', name: 'Vision of NEXORA', fullName: 'Vision of NEXORA', desc: 'Vision of NEXORA module details and configuration.', icon: (p) => <Eye {...p} />, color: 'text-sky-600', bg: 'bg-sky-100' },
  { parentId: 'AboutUs', id: 'au5', name: 'Mission of NEXORA', fullName: 'Mission of NEXORA', desc: 'Mission of NEXORA module details and configuration.', icon: (p) => <Flag {...p} />, color: 'text-emerald-600', bg: 'bg-emerald-100' },
  { parentId: 'AboutUs', id: 'au6', name: 'Key Features of NEXORA', fullName: 'Key Features of NEXORA', desc: 'Key Features of NEXORA module details and configuration.', icon: (p) => <Star {...p} />, color: 'text-amber-600', bg: 'bg-amber-100' },
  { parentId: 'AboutUs', id: 'au7', name: 'Investigation Capabilities of NEXORA', fullName: 'Investigation Capabilities of NEXORA', desc: 'Investigation Capabilities of NEXORA module details and configuration.', icon: (p) => <History {...p} />, color: 'text-purple-600', bg: 'bg-purple-100' },
  { parentId: 'AboutUs', id: 'au8', name: 'Technology & Security of NEXORA', fullName: 'Technology & Security of NEXORA', desc: 'Technology & Security of NEXORA module details and configuration.', icon: (p) => <Key {...p} />, color: 'text-teal-600', bg: 'bg-teal-100' },
  { parentId: 'AboutUs', id: 'au9', name: 'Benefits of NEXORA', fullName: 'Benefits of NEXORA', desc: 'Benefits of NEXORA module details and configuration.', icon: (p) => <Layers {...p} />, color: 'text-cyan-600', bg: 'bg-cyan-100' },
  { parentId: 'AboutUs', id: 'au10', name: 'Target Users of NEXORA', fullName: 'Target Users of NEXORA', desc: 'Target Users of NEXORA module details and configuration.', icon: (p) => <Search {...p} />, color: 'text-violet-600', bg: 'bg-violet-100' },
  { parentId: 'AboutUs', id: 'au11', name: 'Why Choose NEXORA', fullName: 'Why Choose NEXORA', desc: 'Why Choose NEXORA module details and configuration.', icon: (p) => <Cpu {...p} />, color: 'text-fuchsia-600', bg: 'bg-fuchsia-100' },
  { parentId: 'AboutUs', id: 'au12', name: 'Our Commitment', fullName: 'Our Commitment', desc: 'Our Commitment module details and configuration.', icon: (p) => <Shield {...p} />, color: 'text-orange-600', bg: 'bg-orange-100' },
  { parentId: 'AboutUs', id: 'au13', name: 'Support & Services', fullName: 'Support & Services', desc: 'Support & Services module details and configuration.', icon: (p) => <Brain {...p} />, color: 'text-yellow-600', bg: 'bg-yellow-100' },
  { parentId: 'AboutUs', id: 'au14', name: 'Future Roadmap of NEXORA', fullName: 'Future Roadmap of NEXORA', desc: 'Future Roadmap of NEXORA module details and configuration.', icon: (p) => <BarChart {...p} />, color: 'text-blue-600', bg: 'bg-blue-100' },
  { parentId: 'AboutUs', id: 'au15', name: 'Contact NEXORA', fullName: 'Contact NEXORA', desc: 'Contact NEXORA module details and configuration.', icon: (p) => <TrendingUp {...p} />, color: 'text-indigo-600', bg: 'bg-indigo-100' },
  { parentId: 'AboutUs', id: 'au16', name: 'Privacy Policy', fullName: 'Privacy Policy', desc: 'Privacy Policy module details and configuration.', icon: (p) => <Users {...p} />, color: 'text-rose-600', bg: 'bg-rose-100' },
  { parentId: 'AboutUs', id: 'au17', name: 'Terms & Conditions', fullName: 'Terms & Conditions', desc: 'Terms & Conditions module details and configuration.', icon: (p) => <Building {...p} />, color: 'text-sky-600', bg: 'bg-sky-100' },
  { parentId: 'AboutUs', id: 'au18', name: 'Data Protection Policy', fullName: 'Data Protection Policy', desc: 'Data Protection Policy module details and configuration.', icon: (p) => <GitMerge {...p} />, color: 'text-emerald-600', bg: 'bg-emerald-100' },
  { parentId: 'AboutUs', id: 'au19', name: 'Information Security Policy', fullName: 'Information Security Policy', desc: 'Information Security Policy module details and configuration.', icon: (p) => <Link {...p} />, color: 'text-amber-600', bg: 'bg-amber-100' },
  { parentId: 'AboutUs', id: 'au20', name: 'User Access & Authorization Policy', fullName: 'User Access & Authorization Policy', desc: 'User Access & Authorization Policy module details and configuration.', icon: (p) => <Activity {...p} />, color: 'text-purple-600', bg: 'bg-purple-100' },
  { parentId: 'AboutUs', id: 'au21', name: 'Data Retention & Disposal Policy', fullName: 'Data Retention & Disposal Policy', desc: 'Data Retention & Disposal Policy module details and configuration.', icon: (p) => <Lightbulb {...p} />, color: 'text-teal-600', bg: 'bg-teal-100' },
  { parentId: 'AboutUs', id: 'au22', name: 'Data Classification Policy', fullName: 'Data Classification Policy', desc: 'Data Classification Policy module details and configuration.', icon: (p) => <Map {...p} />, color: 'text-cyan-600', bg: 'bg-cyan-100' },
  { parentId: 'AboutUs', id: 'au23', name: 'Data Sharing & Disclosure Policy', fullName: 'Data Sharing & Disclosure Policy', desc: 'Data Sharing & Disclosure Policy module details and configuration.', icon: (p) => <CheckCircle {...p} />, color: 'text-violet-600', bg: 'bg-violet-100' },
  { parentId: 'AboutUs', id: 'au24', name: 'Lawful Access & Investigation Policy', fullName: 'Lawful Access & Investigation Policy', desc: 'Lawful Access & Investigation Policy module details and configuration.', icon: (p) => <Heart {...p} />, color: 'text-fuchsia-600', bg: 'bg-fuchsia-100' },
  { parentId: 'AboutUs', id: 'au25', name: 'Acceptable Use Policy', fullName: 'Acceptable Use Policy', desc: 'Acceptable Use Policy module details and configuration.', icon: (p) => <Award {...p} />, color: 'text-orange-600', bg: 'bg-orange-100' },
  { parentId: 'AboutUs', id: 'au26', name: 'IT Act & DPDP Act Compliance', fullName: 'IT Act & DPDP Act Compliance', desc: 'IT Act & DPDP Act Compliance module details and configuration.', icon: (p) => <Handshake {...p} />, color: 'text-yellow-600', bg: 'bg-yellow-100' },
  { parentId: 'AboutUs', id: 'au27', name: 'Copyright & Intellectual Property Policy', fullName: 'Copyright & Intellectual Property Policy', desc: 'Copyright & Intellectual Property Policy module details and configuration.', icon: (p) => <ShieldCheck {...p} />, color: 'text-blue-600', bg: 'bg-blue-100' },
  { parentId: 'AboutUs', id: 'au28', name: 'Audit & Logging Policy', fullName: 'Audit & Logging Policy', desc: 'Audit & Logging Policy module details and configuration.', icon: (p) => <LifeBuoy {...p} />, color: 'text-indigo-600', bg: 'bg-indigo-100' },
  { parentId: 'AboutUs', id: 'au29', name: 'Incident Response Policy', fullName: 'Incident Response Policy', desc: 'Incident Response Policy module details and configuration.', icon: (p) => <Phone {...p} />, color: 'text-rose-600', bg: 'bg-rose-100' },
  { parentId: 'AboutUs', id: 'au30', name: 'Disclaimer', fullName: 'Disclaimer', desc: 'Disclaimer module details and configuration.', icon: (p) => <PlayCircle {...p} />, color: 'text-sky-600', bg: 'bg-sky-100' },
  { parentId: 'AboutUs', id: 'au31', name: 'About Us demo 1', fullName: 'About Us demo 1', desc: 'About Us demo 1 module details and configuration.', icon: (p) => <PlayCircle {...p} />, color: 'text-emerald-600', bg: 'bg-emerald-100' },
  { parentId: 'AboutUs', id: 'au32', name: 'About Us demo 2', fullName: 'About Us demo 2', desc: 'About Us demo 2 module details and configuration.', icon: (p) => <PlayCircle {...p} />, color: 'text-amber-600', bg: 'bg-amber-100' },
];
